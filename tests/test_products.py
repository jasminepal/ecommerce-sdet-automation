...
def test_create_product(api_client, test_data):
...
# start from : YES. This is exactly the kind of architecture question we should solve now, before adding 20 more tests. You're spotting a real problem.